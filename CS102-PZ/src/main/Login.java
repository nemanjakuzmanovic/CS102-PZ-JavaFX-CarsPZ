...
public class Login extends Baza {
    ...
    public static void loginWindow(Stage primaryStage) {
        ...
        vb2.getChildren().add(staff);
        vb2.setAlignment(Pos.TOP_RIGHT);
        vb2.setPadding(new Insets(10, 10, 0, 0));

        staff.setStyle("-fx-font: 12 arial; -fx-base: red;");
        ...
        staff.setOnAction(e -> {
            // Ulazak na dugme staff vodi ka admin panelu gde se samo admin i radnici mogu logovati
            Staff.staffWindow(primaryStage);
        ...
        btn.setOnAction(e -> {
            ...
            if (tf1.getText().isEmpty() || tf2.getText().isEmpty()) {
                ...
                if (Functions.logIn(tf1.getText(), tf2.getText())) {
                    UserView.userWindow(primaryStage);

                } else {
                    JOptionPane.showMessageDialog(null, "Korisnik ne postoji ili je sifra pogresna");
                }
            }
