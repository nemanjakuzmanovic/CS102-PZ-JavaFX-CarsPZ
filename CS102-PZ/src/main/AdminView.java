...
public class AdminView {
    ...
    public static void adminWindow(Stage primaryStage) {
        ...
        //prikaz slike pri ulasku u aplikaciju
        ...
        Label titlelbl = new Label("Dobrodošli super korisniče");
        ...
        /*
        Petlja koja za svaki automobil iz baze podataka povlaci taj isti automobil i icrtava slike,
        ispisuje ime automobila, godiste, cenu, info dugme koje prebacuje na sajt polovniautomobili i daje sve informacije o tom automobilu,
        kao i dugme iznajmi pomocu koga korisnik iznajmljuje automobil
         */
        for (int i = 0; i < PolovniFunctions.getAllImgs().size(); i++) {
            ...
            // otvaranje web browsera u novom prozoru u kojem korisnik dobija sve informacije o zeljenom automobilu, povucene sa polovniautomobili.com
            ...
            kupi.setOnAction(e -> {
                ...
                //Kada korisnik izabere automobil, sve informacije o njemu i o automobilu se ispisuje u fajl ugovori
        ...
        Button btn3 = new Button("CRUD Cars");
        Button btn4 = new Button("CRUD Users");
        Button btn5 = new Button("Porudzbine");
        ...
        btn2.setOnAction(e -> {
            //Alert prozor koji daje korisniku osnovne informacije
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Molimo sacekajte");
            alert.setHeaderText("U toku je obrada informacija (~30 sekundi)");
            alert.setContentText("Molimo pritisnite OK, ne dirajte nista i sacekajte. Hvala!");

            alert.showAndWait();
            // Pravljenje objekta i skidanje sa sajta
            Download don = new Download("https://polovniautomobili.com/");

            // Petlja pomocu koje skidamo sa sajta polovniautomobili.com i za svaku sliku koja postoji, ispisujemo naziv,godiste,cenu kao i URL automobila
            for (int i = 0; i < Download.getSlike().size(); i++) {
                ...
                // Otvaranje web browser prozora u kome korisnik dobija osnovne informacije o vozilu
                final WebView browser = new WebView();
                final javafx.scene.web.WebEngine webEngine = browser.getEngine();
                webEngine.load(Download.getInfo().get(i).toString());
                /*
                Ispisivanje u konzoli linkova automobila koji se pomocu JSOUPa skidaju sa polovniautomobili.com
                Iz razloga sto aplikacija zaledi (freez-uje) na 30 sekundi, dok se skida, pa da bi korsnik znao da se nesto desava
                i da ne bi iskljucio aplikaciju u toku svog rada!
                 */
                ...
                kupi2.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent e) {
                        ...
                        //formatiranje i prikaz datuma kada korisnik izabere da iznajmi neki automobil
                        DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
                        Date date = new Date();
        ...
        btn3.setOnAction(e -> {
            VBox vbC = new VBox();
            bp.setCenter(CrudCars.crudCars(vbC));
        });

        btn4.setOnAction(e -> {
            VBox vbC = new VBox();
            bp.setCenter(CrudUsers.crudUsers(vbC));
        });

        btn5.setOnAction(e -> {
            VBox vbC = new VBox();
            try {
                bp.setCenter(Porudzbine.porudzbine(vbC));
            } catch (IOException ex) {
        ...
        vb2.setPadding(new Insets(400, 0, 0, 0));
        vb.getChildren().addAll(btn, btn2, btn3, btn4, btn5);
